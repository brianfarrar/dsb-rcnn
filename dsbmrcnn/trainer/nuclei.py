...
class NucleiConfig(config.Config):
    ...
    #STEPS_PER_EPOCH = int(math.ceil(894 / (IMAGES_PER_GPU * GPU_COUNT)))
...
class NucleiDataset(utils.Dataset):
    ...
    def load_data(self, path, mode='train', filter_ids=None):
        ...
        specimen_ids = dsbhelper.get_specimen_ids(path, mode='directory')
        ...
        if filter_ids is not None:
            if mode is 'train':
                ...
                specimen_ids = ['1d4ec0f5ae4e314287dc3626f0e62ea632eaa4c8f1e2e9c9444de49d072dee4d']
                #pass
            else:
